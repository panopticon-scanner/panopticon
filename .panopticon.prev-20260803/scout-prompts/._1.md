...
- docs/superpowers/2026-08-03-calibration-fixmes.md

Return ONLY the ScopeProfile JSON object (fields: group, files, surfaces, panels, lenses, depth, risk, tools, has_deps). Set "group" to '._1' exactly.
