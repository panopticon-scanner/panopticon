...
Files to profile:
- tests/tools/test_rust_integration.py
- tests/tools/test_spotbugs.py

Return ONLY the ScopeProfile JSON object (fields: group, files, surfaces, panels, lenses, depth, risk, tools, has_deps). Set "group" to '._11' exactly.
