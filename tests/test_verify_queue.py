...
class TestBothPassesAgree(unittest.TestCase):
    ...
    def test_pass1_and_pass2_build_identical_queue_ids(self):
        ...
        p1, _ = corroborate_mod.prepare_for_queue(copy.deepcopy(self._raw()))
        p2, _ = corroborate_mod.prepare_for_queue(copy.deepcopy(self._raw()))
    ...
    def test_aggregation_happens_before_the_queue_is_built(self):
        import copy
        import scripts.synth.corroborate as corroborate_mod
        prepared, _ = corroborate_mod.prepare_for_queue(copy.deepcopy(self._raw()))
